// https://editor.p5js.org/jht9629-nyu/sketches/FkiTjW9bk
// Scarce abacus truchet v1

// only needs 0 90 rotation
...
function mousePressed() {
  if (mouseX >= 0 && mouseX < width && mouseY >= 0 && mouseY < height) {
    ...
    if (col < cols && row < rows) {
      pattern[col][row] = (pattern[col][row] + 1) % 2;
