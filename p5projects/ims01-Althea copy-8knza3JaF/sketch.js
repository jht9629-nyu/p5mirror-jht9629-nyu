// https://editor.p5js.org/jht9629-nyu/sketches/8knza3JaF
// ims01-Althea copy
// https://editor.p5js.org/AltheaXiu/sketches/p9qvZrkDf
// ims01-Althea
...
var cols, rows;
var scl = 20; // controls the density of the triangles
var w = 1400;
var h = 1000;
let theight = 200; // height of triangle
...
function draw() {
  ...
  for (var y = 0; y < rows; y++) {
    var xoff = 0;
    for (var x = 0; x < cols; x++) {
      terrain[x][y] = map(noise(xoff, yoff), 0, 1, -theight, theight);
