...
/*
Write a simple p5js program that has the following features:
1. user selection of an audio file input
2. loop playback and pause buttons for the selected file
3. simultaneously display an waveform of the audio file's amplitude in playback ad pause
*/
