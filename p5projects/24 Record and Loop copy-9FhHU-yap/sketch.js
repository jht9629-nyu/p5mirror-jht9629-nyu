// https://editor.p5js.org/jht9629-nyu/sketches/9FhHU-yap
...
function keyPressed() {
  ...
  console.log('keyPressed state', state);

  if (state === 2) {
    console.log('Loop latest', state);
    console.log('sounds.length-1', sounds.length-1);
