// https://editor.p5js.org/jht9629-nyu/sketches/lyFnL3bxn
// ims02-shane v1
...
function makeTiles(num) {
  ...
  for (
    let y = capturedFrame.height - capturedFrame.height / num;
    y >= 0;
    y -= capturedFrame.height / num
  ) {
    for (
      let x = capturedFrame.width - capturedFrame.width / num;
      x >= 0;
      x -= capturedFrame.width / num
    ) {
      let sx = -(capturedFrame.width / 2) + x + capturedFrame.width / (2 * num);
      let sy =
        -(capturedFrame.height / 2) + y + capturedFrame.height / (2 * num);
...
// https://editor.p5js.org/jht9629-nyu/sketches/l1LZchKgQ
// ims02-shane v0

// https://editor.p5js.org/Xueyu333/sketches/56koQQZER
// ims02-shane
