// https://editor.p5js.org/jht9629-nyu/sketches/zV3BsHs7X
...
function draw() {
  // background(220);
  let nwidth = width + xlen
  fill("black");
  rect(0, 0, xpos, ylen);
  fill("red");
  rect(xpos % nwidth, 0, xlen, ylen);
  fill("green");
  rect((xpos + xlen) % nwidth, 0, xlen, ylen);
  // fill("yellow");
  fill([187, 165, 61]);
  rect((xpos + xlen * 2) % nwidth, 0, xlen, ylen);
