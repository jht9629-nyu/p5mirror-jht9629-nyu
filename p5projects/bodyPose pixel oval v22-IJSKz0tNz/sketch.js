// https://editor.p5js.org/jht9629-nyu/sketches/IJSKz0tNz
// bodyPose pixel oval v22
// full head draw
...
function setup() {
  ...
  my.items = [];
  my.gridCount = 128;
  if (windowWidth < 600) my.gridCount = 64;
  my.restoreSteps = 16;
  my.doRestore = true;
  my.doColor = true;
  my.showPose = false;
...
function draw() {
  ...
  my.fpsSpan.html(frameRate().toFixed(2));
}
...
// https://editor.p5js.org/jht9629-nyu/sketches/6DRHLF0ZJ
// pixel reveal oval v21
