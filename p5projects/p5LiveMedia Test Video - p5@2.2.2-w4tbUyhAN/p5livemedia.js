...
class p5LiveMedia {
  constructor(sketch, type, elem, room, host) {
    ...
    console.log('p5LiveMedia  constructor this.sketch', this.sketch);
    console.log('p5LiveMedia  constructor this.sketch._elements', this.sketch._elements);
    ...
    this.socket.on('listresults', (data) => {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        if (data[i] != this.socket.id) {
          ...
          let simplepeer = new SimplePeerWrapper(this, true, data[i], this.socket, this.mystream);
    ...
    this.socket.on('signal', (to, from, data) => {
      ...
      if (!found) {
        ...
        let simplepeer = new SimplePeerWrapper(this, false, from, this.socket, this.mystream);
  ...
  callOnStreamCallback(domElement, id) {
    if (this.onStreamCallback) {
      ...
      // !!@
      console.log('callOnStreamCallback this.sketch', this.sketch);
      console.log('this.sketch._elements', this.sketch._elements);
