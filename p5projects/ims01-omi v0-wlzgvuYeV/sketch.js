// https://editor.p5js.org/jht9629-nyu/sketches/wlzgvuYeV
// ims01-omi v0
...
function draw() {
  ...
  for (let col = 0; col < total; col += 2) {
    ...
    // copy(source, source x, source y, source w, source h, destination x, destination y, destination w, destination h)
  }
...
// https://editor.p5js.org/omi99/sketches/dkNqmOWwE
// ims01-omi by omi99
